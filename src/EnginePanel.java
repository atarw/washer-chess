...
public class EnginePanel extends JPanel implements ActionListener {
  ...
  public EnginePanel () {
    ...
    analyzeButton = new MaterialButton ("RUN", lookManager.getGUITheme ().getInactiveBorderedButtonBackground (), lookManager.getGUITheme ().getBorderedButtonText (), lookManager.getGUITheme ().getActiveBorderedButtonBackground ());
