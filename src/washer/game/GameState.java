...
import washer.engine.AbstractEngine;
...
public class GameState {
	...
	public Ply getEngineMove () {
		if (!engine.choseMove ()) {
			...
			//Ply ply = washer.engine.negamax (currentBoard, 0, washer.engine.getRoot ().getNode ());
			engine.setChosenMove (ply);
		}
		//System.out.println (washer.engine.getChosenMove ());
