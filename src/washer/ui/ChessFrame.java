...
public class ChessFrame extends JFrame implements ActionListener {
	...
	private JComponent configureComponents () {
		...
		components[0] = new JSplitPane (JSplitPane.VERTICAL_SPLIT, true, lookManager.getMovePanel (), lookManager.getEnginePanel ()); //washer.engine + move list pane
		components[1] = new JSplitPane (JSplitPane.HORIZONTAL_SPLIT, true, lookManager.getBoardPanel (), components[0]); // game + other splitpane
